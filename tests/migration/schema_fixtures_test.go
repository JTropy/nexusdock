...
// 以下三组 DDL 是升级测试的真实历史 fixture，从 git 原样提取，不随生产代码演进：
//   - schemaV0_1_0：v0.1.0 标签的 currentSchema，最老的真实历史结构；
//   - schemaV0_2_0：v0.2.0 标签的 currentSchema；
//   - schemaUnversioned：main@287bffb 的 currentSchema，即引入版本化之前的未版本化现状，
//     与当前生产库的表结构一致。
// 提取来源：git show <rev>:internal/core/schema.go

var schemaV0_1_0 = []string{
