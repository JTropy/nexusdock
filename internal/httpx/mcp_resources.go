...
var nexusOwnedMCPApps = []nexusOwnedMCPApp{
	{URI: imageAppURI, View: "view_image", Title: "NexusDock image", Description: "Display the requested image and attach it to a ChatGPT follow-up."},
